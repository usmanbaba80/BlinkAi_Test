...
from models import (
    ScreenshotRequest, LinkRequest,  # SearchRequest commented out - search endpoint disabled
...
async def init_connection_pool():
    ...
    try:
        async with pool_lock:
            # Configure SSL context for MySQL connection
            ssl_context = None
            if settings.db_ssl_ca:
                ...
                logger.info(f"🔒 Using SSL certificate: {settings.db_ssl_ca}")
...
async def startup_event():
    ...
    try:
        ...
        # # Initialize search optimization components (DISABLED - Search API not needed)
        ...
        # # Initialize HTTP client pool (DISABLED - Not needed for screenshots)
        # try:
        ...
        # # Log search configuration (DISABLED - Search API not needed)
        ...
        # # Test search queue functionality (DISABLED - Search API not needed)
        # try:
        ...
        # # Test search API health (DISABLED - Search API not needed)
        # try:
...
async def shutdown_event():
    ...
    try:
        ...
        # # Log final search metrics before shutdown (DISABLED - Search API not needed)
        # try:
        ...
        # # Clean up HTTP client pool (DISABLED - Not needed for screenshots)
        # try:
        ...
        # # Close GeoIP reader (DISABLED - Not needed)
        # global geoip_reader
        # try:
        #     if geoip_reader:
        #         geoip_reader.close()
